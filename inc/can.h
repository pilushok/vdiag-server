...
enum can_error can_socket_read(struct socket_state *psock_state, struct can_message *pmsg);

enum can_error can_socket_write(struct socket_state *psock_state, const struct can_message *pmsg);
